...
>
  ...
  <g
    ...
    stroke="none"
    strokeWidth="1"
    transform="translate(-664 -1272) translate(40 1187) translate(114) translate(405 1) translate(105.193 83.978)"
  >
    <mask id="c" fill="#fff">
      <use xlinkHref="#a" />
    </mask>
    ...
    <g mask="url(#c)">
      <g fill="none" fillRule="evenodd" strokeWidth="1">
        <path
          ...
          transform="translate(-6.346 -.16)"
        />
        <g transform="translate(-6.346 -.16) translate(0 30.12)">
          <image
            width="74.427"
            height="94.62"
            x="0"
      ...
      <g
        ...
        fillRule="evenodd"
        strokeWidth="1"
        transform="translate(-6.346 -.16) translate(3.422 23.3)"
      >
        <image
          width="119.768"
          height="131.275"
        ...
        <path
          fill="#FFCA28"
          fillRule="nonzero"
          d="M109.502 90.642L95.3 3.097A3.436 3.436 0 0092.964.4a3.454 3.454 0 00-3.48.823L0 90.642l49.532 27.704a10.432 10.432 0 0010.01 0l49.96-27.704z"
